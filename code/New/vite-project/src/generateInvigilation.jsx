...
const GenerateInvigilation = () => {
  ...
  const [searchSeatingText, setSearchSeatingText] = useState("");
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch('http://localhost:3000/api/save-invigilation-assignment', {
        method: 'POST',
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-lg font-medium">{selectedSeatingArrangement.createdAt ? new Date(selectedSeatingArrangement.createdAt).toLocaleString() : 'N/A'}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
          ...
          <Card className="bg-white">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-blue-50 rounded-lg p-4">
                <h3 className="font-medium mb-3 text-blue-900">Faculty ({invigilatorsData.faculty.length})</h3>
                  <Input
                    type="text"
                  ...
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {invigilatorsData.faculty
                      .filter(f => f.name.toLowerCase().includes(searchFaculty.toLowerCase()))
                      .map((faculty, index) => (
                ...
                <div className="bg-green-50 rounded-lg p-4">
                <h3 className="font-medium mb-3 text-green-900">Staff ({invigilatorsData.staff.length})</h3>
                  <Input
                    type="text"
                  ...
                  />
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {invigilatorsData.staff
                      .filter(s => s.name.toLowerCase().includes(searchStaff.toLowerCase()))
                      .map((staff, index) => (
